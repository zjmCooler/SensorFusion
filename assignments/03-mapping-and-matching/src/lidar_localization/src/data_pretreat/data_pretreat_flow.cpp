...
bool DataPretreatFlow::TransformData() {
    ...
    std::cout << origin_gnss_data_.longitude << " " << origin_gnss_data_.latitude << " " << origin_gnss_data_.altitude << std::endl;
